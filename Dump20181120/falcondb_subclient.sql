...
CREATE TABLE `subclient` (
  `SubClientID` varchar(100) NOT NULL,
  `SubClientName` varchar(100) DEFAULT NULL,
...
INSERT INTO `subclient` VALUES ('176116','Blue Cross and Blue Shield of Minnesota','BCBSMN');
...
-- Dump completed on 2018-11-20 18:34:02
